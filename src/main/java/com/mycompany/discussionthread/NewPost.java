...
public class NewPost extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DiscussionPosts post = new DiscussionPosts(username, text, (String)dateFormat.format(date));
        
        XmlPostStorage myXml = new XmlPostStorage();
        myXml.addPost(post);
        myXml.write();
        List<DiscussionPosts> sendList = myXml.getPostList();
